...
* Added [`context` support](https://pkg.go.dev/github.com/mc2soft/reform?tab=doc#hdr-Context).
* Added [`Querier.Count`](https://godoc.org/github.com/mc2soft/reform#Querier.Count).
